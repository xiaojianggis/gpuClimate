...
Please report defects to the `the GitLab Tracker <https://gitlab.com/lixiaojianggis/gpuclimateissues>`_
...
If you wish to propose a feature, please file an issue on `the GitLab Tracker <https://gitlab.com/lixiaojianggis/gpuclimateissues>`_ using the **Feature** description template. Community members will help refine and design your idea until it is ready for implementation.
...
gpuclimate could always use more documentation, whether as part of the official gpuclimate docs, in docstrings, tutorials and even on the web in blog posts, articles and such.
...
After an issue is created, the progress of the issues is tracked on the `GitLab issue board <https://gitlab.com/lixiaojianggis/gpuclimateboards>`_.
The maintainers will update the state using `labels <https://gitlab.com/lixiaojianggis/gpuclimatelabels>`_ .
...
If you are
Thank you very much
for your hard work in improving gpuclimate.


Setting up gpuclimate for local development
------------------------------------------------

Ready to contribute? Here's how to set up `gpuclimate` for local development.

1. Fork the `gpuclimate` repo on GitLab.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/gpuclimate.git

3. Install your local copy into a virtualenv. Assuming you have virtualenvwrapper installed, this is how you set up your fork for local development::

    $ mkvirtualenv gpuclimate
    $ cd gpuclimate/
    $ pip install -e .
...
5. When you're done making changes, check that your changes pass flake8, the tests and have test coverage::
  ...
  The docs will be located in `gpuclimate/docs/_build`.
...
.. tip:: Running parts of the test suite
    ...
    .. code-block:: shell
        ...
        $ py.test tests/measurement --cov gpuclimate/measurement

    will look for tests located in the tests/measurement directory and report test coverage of the gpuclimate/measurement module.
